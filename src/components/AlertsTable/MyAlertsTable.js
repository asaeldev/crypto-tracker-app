...
import classes from "./MyAlertsTable.module.css";
...
export default function MyAlertsTable(props) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        ${Number(row.desiredPrice).toFixed(2)}
                      </TableCell>
                      <TableCell align="left">{row.telegramId}</TableCell>
                      <TableCell align="left">Sí</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
